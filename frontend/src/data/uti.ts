...
const redFlagFields: BooleanField[] = [
  {
    key: 'flankPain',
    label: { en: 'Flank pain or CVA tenderness', 'pt-BR': 'Dor lombar/flanco ou punho-percussão positiva' },
    type: 'boolean',
    defaultValue: false,
    narrative: { whenTrue: { en: 'flank pain or CVA tenderness', 'pt-BR': 'dor lombar/flanco ou punho-percussão positiva' } },
  },
  {
    key: 'nauseaVomiting',
...
const obstructionSymptomsField: MultiselectField = {
  ...
  label: { en: 'Obstruction symptoms', 'pt-BR': 'Sintomas obstrutivos' },
  type: 'multiselect',
  options: [
    { label: { en: 'Unable to void', 'pt-BR': 'Incapaz de urinar' }, value: 'unable-to-void', narrative: { en: 'inability to void', 'pt-BR': 'incapacidade de urinar' } },
...
const catheterField: SelectField = {
  key: 'urinaryCatheter',
  label: { en: 'Urinary catheter', 'pt-BR': 'Cateter urinário' },
  type: 'select',
  options: [
    { label: { en: 'None', 'pt-BR': 'Nenhum' }, value: 'none', narrative: { en: 'no urinary catheter', 'pt-BR': 'sem cateter urinário' } },
    ...
    { label: { en: 'Suprapubic catheter', 'pt-BR': 'Cateter suprapúbico' }, value: 'suprapubic', narrative: { en: 'suprapubic catheter', 'pt-BR': 'cateter suprapúbico' } },
...
const prostateSymptomsField: BooleanField = {
  ...
  label: { en: 'Perineal/prostate symptoms', 'pt-BR': 'Sintomas perineais/prostáticos' },
  type: 'boolean',
  defaultValue: false,
...
const oralToleranceField: BooleanField = {
  key: 'oralTolerance',
  label: { en: 'Able to tolerate oral intake', 'pt-BR': 'Tolera via oral' },
  type: 'boolean',
  defaultValue: true,
  narrative: { whenTrue: { en: 'able to tolerate oral intake', 'pt-BR': 'tolerando via oral' } },
}
...
const hpiTemplate = {
  ...
  'pt-BR': `
    ...
    {% assign upperTract = fever | compact_append: temperature | compact_append: flankPain | compact_append: nauseaVomiting | compact_append: systemicSymptoms %}
    {% if upperTract %}Achados sistêmicos ou de trato alto incluem {{ upperTract | list: locale }}.{% endif %}
    {% if obstructionSymptoms %}Sintomas obstrutivos incluem {{ obstructionSymptoms | list: locale }}.{% endif %}
    {% assign alternatives = vaginalDischarge | compact_append: genitalLesions | compact_append: diarrhea | compact_append: respiratorySymptoms %}
    {% if alternatives %}Achados que sugerem diagnóstico alternativo incluem {{ alternatives | list: locale }}.{% endif %}
    {% assign riskContext = pregnancyStatus | compact_append: recentUti | compact_append: recentAntibiotics | compact_append: resistantOrganismHistory | compact_append: diabetes | compact_append: immunocompromised | compact_append: urinaryCatheter | compact_append: urologicAbnormality | compact_append: prostateSymptoms | compact_append: oralTolerance %}
    {% if riskContext %}Contexto de risco e disposição inclui {{ riskContext | list: locale }}.{% endif %}
    {% assign details = recentAntibioticName | compact_append: resistantOrganismName | compact_append: immunocompromiseDetails | compact_append: urologicDetails %}
...
export const utiModule: ClinicalWorkflow = {
  ...
  overview: {
    ...
    'pt-BR': 'Faça a triagem de sintomas urinários por sinais de alerta, padrão clássico de cistite, diagnósticos alternativos, risco de resistência e fatores de ITU complicada.',
  },
  sections: [
    {
      id: 'patient-context',
    ...
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Achados positivos aqui afastam triagem simples de ITU e podem exigir avaliação presencial no mesmo dia ou emergência.',
      },
      fields: [
        feverField,
        temperatureField,
    ...
    },
    {
      ...
      title: { en: 'Resistance and complication risk', 'pt-BR': 'Risco de resistência e complicação' },
      fields: [
  ...
  redFlags: [
    {
      ...
      description: {
        ...
        'pt-BR': 'Levanta suspeita de pielonefrite ou infecção complicada de trato alto.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Sugere possível urosepse e necessidade de escalonamento urgente.',
      },
    },
    {
    ...
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Define contexto de ITU complicada ou de maior risco e reduz limiar para cultura e investigação ampliada.',
      },
    },
  ],
  differentials: [
    {
      ...
      description: {
        ...
        'pt-BR': 'Disúria, polaciúria, urgência e desconforto suprapúbico sem febre, dor em flanco ou corrimento vaginal.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Febre, calafrios, dor em flanco, punho-percussão positiva, náuseas, vômitos ou doença sistêmica.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Calafrios intensos, instabilidade hemodinâmica, alteração mental, má perfusão ou toxicidade sistêmica.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Disúria com secreção, lesões genitais, rash, exposição sexual de risco ou urina negativa.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Corrimento, prurido, odor, dispareunia ou disúria externa.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Dor em flanco tipo cólica, hematúria, retenção importante, incapacidade de urinar ou risco de uropatia obstrutiva.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Paciente masculino com dor pélvica/perineal, sintomas obstrutivos, febre ou próstata dolorosa.',
      },
    },
  ],
  workup: [
    {
      title: { en: 'Urinalysis when presentation is not low-risk classic cystitis', 'pt-BR': 'EAS quando apresentação não for cistite clássica de baixo risco' },
      description: {
    ...
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Obter em homens, idade >=65 anos, ITU recorrente, antibiótico recente, falha terapêutica, resistência prévia, gestação, imunossupressão, cateter ou suspeita de pielonefrite.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Gestação altera estratificação de risco, limiar para cultura e escolha de antibiótico.',
      },
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Considere com corrimento, lesões genitais, irritação, sintomas pélvicos, exposição sexual de risco ou disúria atípica.',
      },
    },
    {
  ...
  quickGuides: [
    {
      ...
      criteria: [
        ...
        { en: 'No fever, flank pain, nausea/vomiting, systemic illness, or obstruction symptoms', 'pt-BR': 'Sem febre, dor em flanco, náuseas/vômitos, doença sistêmica ou obstrução' },
        { en: 'No vaginal discharge and no resistance or complicated UTI risk factors', 'pt-BR': 'Sem corrimento vaginal e sem fatores de resistência ou ITU complicada' },
      ],
      actions: [
        ...
        { en: 'Provide return precautions for fever, flank pain, worsening symptoms, or oral intolerance', 'pt-BR': 'Orientar retorno por febre, dor em flanco, piora ou intolerância oral' },
      ],
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Use quando houver risco de resistência, contexto de ITU complicada ou apresentação fora de baixo risco.',
      },
      criteria: [
        { en: 'Male patient, age 65 or older, recurrent UTI, recent antibiotics, or resistant organism history', 'pt-BR': 'Homem, idade >=65 anos, ITU recorrente, antibiótico recente ou resistência prévia' },
      ...
      actions: [
        ...
        { en: 'Document reason for culture and plan to adjust therapy to susceptibilities', 'pt-BR': 'Documentar motivo da cultura e plano de ajuste conforme antibiograma' },
      ],
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Use quando sintomas sugerem pielonefrite, obstrução, sepse ou outro diagnóstico.',
      },
      criteria: [
        { en: 'Fever, flank pain/CVA tenderness, nausea/vomiting, rigors, hemodynamic instability, or altered mental status', 'pt-BR': 'Febre, dor em flanco/punho-percussão, náuseas/vômitos, calafrios intensos, instabilidade ou alteração mental' },
      ...
      actions: [
        { en: 'Arrange same-day in-person evaluation or ED care depending on severity', 'pt-BR': 'Organizar avaliação presencial no mesmo dia ou emergência conforme gravidade' },
        { en: 'Consider labs, cultures, IV therapy, imaging, or urology involvement when indicated', 'pt-BR': 'Considerar exames, culturas, terapia IV, imagem ou urologia quando indicado' },
      ],
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Use quando sintomas afastam cistite simples isolada.',
      },
      criteria: [
      ...
      actions: [
        { en: 'Evaluate for vaginitis, urethritis/STI, gastroenteritis, respiratory infection, stones, or other causes', 'pt-BR': 'Avaliar vaginite, uretrite/IST, gastroenterite, infecção respiratória, cálculos ou outras causas' },
      ],
    },
  ],
  sourceFigures: [
    {
      ...
      notes: {
        ...
        'pt-BR': 'Algoritmo-fonte revisado localmente para elegibilidade de tratamento empírico, gatilhos de exame de urina, triagem de diagnóstico alternativo e critérios de avaliação no mesmo dia.',
      },
    },
    {
      title: {
      ...
      notes: {
        ...
        'pt-BR': 'Tabela-fonte revisada localmente para diagnóstico clínico de ITU não complicada, indicações de cultura, antibióticos de primeira linha, hidratação e estratégia de antibiótico postergado.',
      },
    },
  ],
  presets: [
    ...
    },
    {
      ...
      description: {
        ...
        'pt-BR': 'Sintomas clássicos com ITU recente, antibiótico recente, diabetes ou outro contexto de resistência.',
      },
      answers: {
        sex: 'female',
        age: '45 years',
